...
# bert配置
config_path = '/root/e/bert/uncased_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '/root/e/bert/uncased_L-12_H-768_A-12/bert_model.ckpt'
dict_path = '/root/e/bert/uncased_L-12_H-768_A-12/vocab.txt'
...
class data_generator(DataGenerator):
    ...
    def __iter__(self, random=False):
        ...
        for i in idxs:
            D = self.data[i]
            img = '/root/e/train2014/%s' % D['image_id']
...
# 加载数据
train_data = read_caption('/root/e/captions_train2014.json')
valid_data = read_caption('/root/e/captions_val2014.json')
...
def just_show():
    ...
    for D in samples:
        img = '/root/e/val2014/%s' % D['image_id']
